...
void ArgValMvdethghxyt::Init(int argc, char* argv[])
{
    progname_ = "mvdethghxyt";
...
void ArgValMvdethghxyt::Print(FILE* fp) const
{
...
void ArgValMvdethghxyt::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
        MPrintInfo("start...");
    }
...
void ArgValMvdethghxyt::Usage(FILE* fp) const
{
    fprintf(fp,
